...
qaSlide({
  ...
  rows: [
    { qa: "QA1. 이기종 환경 배치 품질", a: "★★☆", b: "★★★",
      why: "구분 가능 등급 1종 vs 8종. C2의 ★★★는 분류가 맞고 유보량이 적절할 때의 값 — 유보하지 않으면 실측 구분 지표가 2.11로 C1(2.06)과 같아진다" },
    { qa: "QA2. 결정 정보 비용", a: "★★★", b: "★★☆",
  ...
  foot: "★★★ 구조적으로 유리 · ★★☆ 가능하나 비용 발생 · ★☆☆ 구조적으로 불리   |   실측값 출처: doc-mk/prototype (테스트 31건)",
  notes:
    "동점이므로 결론은 '조건부 선택'. C2의 이득은 알 수 없는 값 두 가지 — 수명 예측 정확도와 유보량 — 에 걸려 있다.",
});
